...
import { Box, makeStyles, TableBody, Table, TableCell, TableRow, Typography, Grid } from "@material-ui/core";
            ...
            <Grid item lg={8} md={8} sm={8} xs={12} className={classes.rightContainer}>
                 ...
                 <Typography className={clsx(classes.smallText, classes.greyTextColor)}>
                     ...
                     <Typography>
                         ...
                         <span className={clsx(classes.smallText, classes.greyTextColor)}><strike>₹{product.price.mrp}</strike></span>&nbsp;&nbsp;&nbsp;&nbsp;
